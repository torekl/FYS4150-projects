...
\subsection{Programs}
All programs used for solving the equation with these three algorithms and plotting the results, as well as the results used referred to later in this text, can be seen at \url{https://github.com/torekl/FYS4150-projects}.
\section{Results}
